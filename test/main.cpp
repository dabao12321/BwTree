...
void ycsb_load_run_randint(TreeType *t, int index_type, int wl, int kt, int ap, int num_thread,
...
int main(int argc, char **argv) {
  ...
  if(run_ycsb_test == true) {
    ...
    if (kt != STRING_KEY) {
        ...
        ycsb_load_run_randint(t1, index_type, wl, kt, ap, num_thread, init_keys, keys,ranges_end, ranges, ops);
    } 
